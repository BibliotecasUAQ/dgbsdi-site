...
<xsl:stylesheet version="1.0"
 ...
 <xsl:when test="$leader6='g'">Película</xsl:when>
 <xsl:when test="$leader6='k'">Imagen</xsl:when>
 ...
 <span class="label">Número de editor: </span>
 ...
 <span class="label">Analíticas: </span>
 <a>
 <xsl:choose>
 ...
 <xsl:with-param name="label">Detalles de publicación: </xsl:with-param>
 </xsl:call-template>
 </xsl:if>
 ...
 <span class="results_summary publisher"><span class="label">Detalles de publicación: </span>
 ...
 <span class="label">Tipo de soporte: </span>
 <ul class="resource_list">
 ...
 <span class="label">Trabajos contenidos: </span>
 <ul class="resource_list">
 ...
 <a>
 <xsl:attribute name="class">asunto</xsl:attribute>
 <xsl:choose>
 ...
 <span class="label">Género/Forma: </span>
 <ul class="resource_list">
 ...
 <xsl:with-param name="delimeter"> AND </xsl:with-param>
 <xsl:with-param name="prefix">(índice-término-género<xsl:value-of select="$SubjectModifier"/>:<xsl:value-of select="$TracingQuotesLeft"/></xsl:with-param>
 <xsl:with-param name="suffix"><xsl:value-of select="$TracingQuotesRight"/>)</xsl:with-param>
 <xsl:with-param name="urlencode">1</xsl:with-param>
 </xsl:call-template>
 </xsl:attribute>
 ...
 <xsl:otherwise>
 <xsl:attribute name="href">/cgi-bin/koha/opac-buscar.pl?q=índice-término-género<xsl:value-of select="$SubjectModifier"/>:<xsl:value-of select="$TracingQuotesLeft"/><xsl:value-of select="str:encode-uri(marc:subfield[@code='a'], true())"/><xsl:value-of select="$TracingQuotesRight"/></xsl:attribute>
 </xsl:otherwise>
 </xsl:choose>
 <xsl:call-template name="subfieldSelect">
 <xsl:with-param name="codes">avxyz</xsl:with-param>
...
<!-- MARC21 776 Additional Physical Form Entry -->
 ...
 <span class="label">Formatos físicos adicionales: </span>
...
<!-- MARC21 777 - Issued With Entry -->
 ...
 <xsl:otherwise>
 <xsl:text>Publicado con:</xsl:text>
 </xsl:otherwise>
 </xsl:choose>
 <xsl:text> </xsl:text>
 </span>
...
<!-- LOC classification -->
 ...
 <span class="label">Clasificación LoC:</span>
 <ul class="resource_list">
...
<!-- NLM classification -->
 ...
 <span class="label">Clasificación NLM: </span>
 <ul class="resource_list">
...
<!-- Other classification -->
 ...
 <span class="label">Otra clasificación: </span>
 <ul class="resource_list">
 ...
 <span class="results_summary other_relationship_entry"><span class="label">Otras obras relacionadas: </span>
 ...
 <span class="label">Nota de acción: </span>
 <ul class="resource_list">
 ...
 <span class="results_summary holdings_note basic_bibliographic_unit"><span class="label">Existencias: </span>
 ...
 <span class="label">Suplemento de: </span>
 <ul class="resource_list">
 ...
 <xsl:text>Archivo de sonido</xsl:text>
 </a>
 </span>
 </xsl:if>
 ...
 <xsl:text> Reproducir esta muestra</xsl:text>
 </button>
 </div>
 </xsl:if>
 </xsl:if>
 ...
 <xsl:attribute name="class">colaboradores</xsl:attribute>
